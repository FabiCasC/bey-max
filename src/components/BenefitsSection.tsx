import { Award, BarChart3, Brain, BadgeIcon as Certificate, Settings, Users } from 'lucide-react'
    ...
    return (
        ...
        <div className="text-center mb-12">
            ...
            Por Qué Elegir VirtuCare AI
            </h2>
            <p className="text-[#4B5563] text-lg max-w-2xl mx-auto">
            Descubre cómo nuestra plataforma transforma la educación médica a nivel individual e institucional
            </p>
        </div>
            ...
            <div className="relative">
                ...
                <div className="relative z-10">
                    ...
                    <BenefitItem
                        ...
                        title="Mejora en Habilidades"
                        description="Desarrolla tanto habilidades técnicas como empáticas a través de simulaciones realistas"
                    />
                    <BenefitItem
                        icon={<Certificate className="w-6 h-6 text-[#00D1B2]" />}
                        title="Certificados Digitales"
                        description="Obtén certificaciones validadas por instituciones reconocidas"
                    />
                    <BenefitItem
            ...
            <div className="relative">
                ...
                <div className="relative z-10">
                    ...
                    <BenefitItem
                        ...
                        description="Adapta los escenarios según los protocolos específicos de tu institución"
                    />
                    <BenefitItem
                        icon={<BarChart3 className="w-6 h-6 text-[#00D1B2]" />}
                        title="Análisis Detallado"
                        description="Monitorea el progreso grupal con métricas avanzadas en tiempo real"
                    />
                    <BenefitItem
                        icon={<Users className="w-6 h-6 text-[#00D1B2]" />}
                        title="Gestión de Equipos"
                        description="Administra grupos y coordina entrenamientos de manera eficiente"
                    />
                    </div>
                </div>
                </div>
